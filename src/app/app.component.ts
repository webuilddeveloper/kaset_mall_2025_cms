...
export class AppComponent {
  ...
  login(username, password) {
    ...
    if (username == 'admin' && password == 'p@ssw0rd') {
      localStorage.setItem('category', JSON.stringify({ organizationPage: true, userRolePage: true, memberPage: true, createAction: true, readAction: true, updateAction: true, deleteAction: true, approveAction: true }));
